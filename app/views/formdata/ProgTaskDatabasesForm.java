 ...
 * @author atovar
 */
public class ProgTaskDatabasesForm {
    ...
    public List<ValidationError> validate() {
        ...
        if(selConnection == null || selConnection.isEmpty()){
            errors.add(new ValidationError("selConnection", "Debe seleccionar la conexi\u00F3n que se programar\u00E1"));
        }
        
        String taskResp = checkTask(fillTasks(),selConnection);
        if(!taskResp.equals("")){
            errors.add(new ValidationError("otherErrors", "Esta programaci\u00F3n ya existe para esta conexi\u00F3n!!! Si desea puede modificarla en el siguiente item (Editar programaci\u00F3n de tareas)..."));
        }
