...
public class ProgrammingTaskBD {
    /**
     * Creates a new instance of ProgrammingTaskBD
     */
    //El horario de la tarea
    private Scheduler horario;
    String nameTrigger = "triggerBD";
    String nameTarea = "taskBD";
    ...
    public ProgrammingTaskBD(String porMinutos, String porHoras, String dia, String diaSemana, String diaMes, int hora, int min, String selConexion, String folderRaiz) {
    ...
    private void crearProgramacion() {
        ...
        try {
            ...
            logger.error("Se genero error programando la tarea para Base de datos:" + ex.getMessage());
        }
    ...
    public void iniciarTarea() throws SchedulerException {
        ...
        JobDetail job = new JobDetail(nameTarea, InvokeTaskBD.class);
        ...
        if(porMinutos!=null && !porMinutos.equals("")){
            logger.info("Programacion del Proceso para Base de datos --> Cada "+porMinutos+" minuto(s).");
            ...
            logger.info("Programacion del Proceso para Base de datos --> Cada "+porHoras+" hora(s).");
        ...
        logger.info("Programacion del Proceso para Base de datos --> Cada "+dia+diaSemana+diaMes+" a las "+hora+":"+min);
	...
	startTime.set(Calendar.SECOND , 0);
        ...
        try {
            ...
            logger.error("Se genero error con el horario del proceso para la Base de datos: " + ex.getMessage());
        }
    }
